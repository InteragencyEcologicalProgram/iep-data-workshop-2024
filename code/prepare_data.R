...
# saveRDS(malWaterTemp, here("data/processed/CDEC_MAL_2024.rds"))
...
write_csv(Dayflow, here("data/processed/dayflow_1929_2023.csv"))
...
# Write out the table
# write_csv(df_wytype, here("data/processed/wytype_1906_cur.csv"))

# Downloading DJFMP data -----------------------------------
...
# saveRDS(djfmp_sites0, "data/processed/djfmp_stations.rds")
...
# write_csv(inun_2016_2019, "data/processed/yolo_inun_2016_2019.csv")
# write_csv(chl_2016_2019, "data/processed/yolo_chl_2016_2019.csv")
